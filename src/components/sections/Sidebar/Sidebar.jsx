...
const Sidebar = () => {
  return (
    <aside className="sticky top-0 bg-white dark:bg-zinc-900 md:mx-8 lg:mx-4 mb-8 p-6 shadow-md rounded-md -mt-40">
      <div className="w-24 h-24 rounded-md overflow-hidden mx-auto mb-5">
        <img src={profile} alt="fahminurfalah" className="w-full" />
      </div>
      <div className="text-center">
        <h1 className="text-xl text-gray-800 dark:text-gray-50 font-bold mb-1">John Doe</h1>
        <p className="text-sm text-gray-400 dark:text-gray-50 mb-3">
          Frontend Web Developer at
          <a href="#0" className="text-rose-800 pl-1">
            Abc Company
          </a>
        </p>
        <a
          href="#0"
          className="inline-block mb-3 rounded bg-rose-800 text-center border-0 py-2 px-6 text-white leading-7 tracking-wide hover:bg-rose-950"
          download="Resume"
        >
          Download Resume
        </a>
